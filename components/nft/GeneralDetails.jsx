...
const style = {
  wrapper: `flex mt-8 md:mt-0`,
  infoContainer: `h-36 flex flex-col flex-1 justify-between mb-6`,
  accent: `text-[#2081e2]`,
  nftTitle: `text-3xl font-extrabold`,
  otherInfo: `flex`,
  ownedBy: `text-[#8a939b] mr-4 break-words`,
  likes: `flex items-center break-words text-[#8a939b]`,
  likeIcon: `mr-1 break-words`,
  actionButtonsContainer: `w-44 cursor-pointer`,
  ...
  return (
    <div className={style.wrapper}>
      <div className={style.infoContainer}>
        <div className={style.accent}>Primates</div>
